...
#define WLAN_FRW_EVENT_CFG_TABLE_CFG_VAP \
    /* 队列权重   队列最大事件个数   队列调度策略       事件类型                 */ \
    { 1,          64,              0, 0}, /* FRW_EVENT_TYPE_HIGH_PRIO        */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_HOST_CRX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_HOST_DRX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_HOST_CTX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_DMAC_TO_HMAC_CFG */ \
    { 1,          64,              0, 0}, /* FRW_EVENT_TYPE_WLAN_CRX         */ \
    { 1,          128,             1, 0}, /* FRW_EVENT_TYPE_WLAN_DRX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_WLAN_CTX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_WLAN_DTX         */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_WLAN_TX_COMP     */ \
    { 1,          0,               1, 0}, /* FRW_EVENT_TYPE_TBTT             */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_TIMEOUT          */ \
    { 1,          64,              0, 0}, /* FRW_EVENT_TYPE_DMAC_MISC        */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_HCC              */
...
#define WLAN_FRW_EVENT_CFG_TABLE_SERVIC_VAP \
    ...
    { 1,          0,               0, 0}, /* FRW_EVENT_TYPE_HIGH_PRIO        */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_HOST_CRX         */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_HOST_DRX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_HOST_CTX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_DMAC_TO_HMAC_CFG */ \
    { 1,          128,             0, 0}, /* FRW_EVENT_TYPE_WLAN_CRX         */ \
    { 1,          128,             1, 0}, /* FRW_EVENT_TYPE_WLAN_DRX         */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_WLAN_CTX         */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_WLAN_DTX         */ \
    { 1,          0,               1, 0}, /* FRW_EVENT_TYPE_WLAN_TX_COMP     */ \
    { 1,          32,              1, 0}, /* FRW_EVENT_TYPE_TBTT             */ \
    { 1,          0,               1, 0}, /* FRW_EVENT_TYPE_TIMEOUT          */ \
    { 1,          64,              0, 0}, /* DMAC FRW_EVENT_TYPE_DMAC_MISC   */ \
    { 1,          64,              1, 0}, /* FRW_EVENT_TYPE_HCC              */
