...
#if (_PRE_OS_VERSION_LITEOS == _PRE_OS_VERSION)
unsigned int get_wlan_resume_wifi_init_flag(void)
{
    return g_ul_wlan_resume_wifi_init_flag;
}

void set_wlan_resume_wifi_init_flag(unsigned int flag)
{
    g_ul_wlan_resume_wifi_init_flag = flag;
}
#endif
