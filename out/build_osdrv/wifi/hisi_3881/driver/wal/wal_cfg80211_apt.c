...
/*****************************************************************************
 ...
 功能描述  : 关联结果上报接口
 输入参数  : oal_net_device_stru, oal_connet_result_stru
 输出参数  : oal_connet_result_stru
 返 回 值  : 无
...
/*****************************************************************************
 ...
 功能描述  : 去关联上报接口
 输入参数  : oal_net_device_stru, us_reason, ie帧相关信息
...
/*****************************************************************************
 ...
 功能描述  : 扫描完成上报接口
 输入参数  : oal_net_device_stru, hisi_scan_status_enum
...
/*****************************************************************************
 ...
 功能描述  : DFX上报接口(私有接口)
 输入参数  : oal_net_device_stru, puc_data, data_len
...
/*****************************************************************************
 ...
 功能描述  : 上报mic攻击
 输入参数  : oal_net_device_stru, hmac_mic_event_stru, oal_gfp_enum_uint8
 输出参数  : 无
 返 回 值  : hi_u32
