...
CVI_S32 flash_partition_info_init(CVI_FLASH_TYPE_E FlashType)
{
	CVI_S32 ret = -1;
	CVI_S32 i = 0;
	...
	if (fp) {
		...
		while (i < MAX_MTD_PARTITION) {
			...
			pstPartInfo->FlashType = FlashType;
