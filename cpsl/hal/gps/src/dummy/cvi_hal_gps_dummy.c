...
static int32_t GPSDummyGetRawData(CVI_GPSDATA_S* gpsData, int32_t timeout_ms)
{
    if (NULL == gpsData)
    {
    ...
    if (g_gpsStrLenIndex < (strlen(g_gpsInfo[g_gpsInfoTypeIndex]) + 1))
    {
