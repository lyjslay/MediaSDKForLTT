...
int32_t test_handler_none(void *handle) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
    return 0;
}

int32_t test_handler_void(void *handle, void *arg1) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
...
int32_t test_handler2_void(void *handle, TestData *arg1) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
    arg1->check++;
    return 0;
...
int32_t test_handler_int(void *handle, int32_t arg1) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
    EXPECT_EQ(arg1, 1);
    return 0;
...
int32_t test_handler2_int(void *handle, int32_t arg1) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
    EXPECT_EQ(arg1, 1);
    return 0;
...
int32_t test_handler_int64(void *handle, int64_t arg1) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
...
int32_t test_handler_int_int(void *handle, int32_t arg1, int32_t arg2) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
    EXPECT_EQ(arg1, 1);
    EXPECT_EQ(arg2, 2);
...
int32_t test_handler_uint32_uint32(void *handle, uint32_t arg1, uint32_t arg2) {
    TestContext *context = static_cast<TestContext*>(handle);
    context->check++;
    EXPECT_EQ(arg1, 1);
    EXPECT_EQ(arg2, 2);
