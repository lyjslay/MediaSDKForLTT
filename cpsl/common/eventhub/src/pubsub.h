 ...
 */
int32_t ps_subscribe(ps_subscriber_t *su, const uint32_t topic);
 ...
 */
int32_t ps_subscribe_many(ps_subscriber_t *su, uint32_t *subs);
 ...
 */
int32_t ps_unsubscribe(ps_subscriber_t *su, const uint32_t topic);
 ...
 * @return the number of unsubscribed topics
 */
int32_t ps_unsubscribe_many(ps_subscriber_t *su, uint32_t *subs);
...
int32_t ps_get_topic_sticky_msg(uint32_t topic, ps_msg_t *msg);
 ...
 */
int32_t ps_flush(ps_subscriber_t *su);
/**
 ...
 */
int32_t ps_waiting(ps_subscriber_t *su);
 ...
 */
int32_t ps_overflow(ps_subscriber_t *su);
...
int32_t ps_stats_live_msg(void);
int32_t ps_stats_live_subscribers(void);
void ps_clean_sticky(const char *prefix);

void clean_all_subscribers(void);
int32_t unregister_topic(const uint32_t topic);
int32_t register_topic(const uint32_t topic);
