...
typedef enum cviDTCF_FILE_TYPE_E
{
    ...
    CVI_DTCF_FILE_TYPE_MKV,
    CVI_DTCF_FILE_TYPE_WMV,
    CVI_DTCF_FILE_TYPE_AVI,
    CVI_DTCF_FILE_TYPE_RMVB,
    CVI_DTCF_FILE_TYPE_FLV,
    CVI_DTCF_FILE_TYPE_3GP,
    CVI_DTCF_FILE_TYPE_MPG,
    CVI_DTCF_FILE_TYPE_MXF,
    CVI_DTCF_FILE_TYPE_WMA,
    CVI_DTCF_FILE_TYPE_WAV,
    CVI_DTCF_FILE_TYPE_MP3,
    CVI_DTCF_FILE_TYPE_AAC,
