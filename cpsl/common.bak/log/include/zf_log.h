 ...
 *   #include <zf_log.h>
 *   static int32_t g_module_log_level = ZF_LOG_INFO;
 *   static void foo() {
...
#define ZF_LOG_DEFINE_GLOBAL_OUTPUT_LEVEL int32_t _zf_log_global_output_lvl
...
{
	int32_t lvl; /* Log level of the message */
...
extern int32_t _zf_log_global_output_lvl;
...
static _ZF_LOG_INLINE void _zf_log_unused(const int32_t dummy, ...) {(void)dummy;}
