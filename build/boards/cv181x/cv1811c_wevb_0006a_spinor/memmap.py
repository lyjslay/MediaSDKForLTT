...
class MemoryMap:
    ...
    UIMAG_ADDR = DRAM_BASE + 8 * SIZE_1M
    ...
    # skip ion update
    CONFIG_SYS_TEXT_BASE = UIMAG_ADDR + UIMAG_SIZE + 1 * SIZE_1M
    assert CONFIG_SYS_TEXT_BASE <= ION_ADDR
    # fdt loading addr must skip opensbi
    SPL_FDT_ADDR = UIMAG_ADDR + UIMAG_SIZE + 512 * SIZE_1K
    # assert CVI_SPL_FDT_ADDR <= CONFIG_SYS_TEXT_BASE
