...
class MemoryMap:
    ...
    # =============================
    ALIOS_SYS_SIZE = 6 * SIZE_1M + 512 * SIZE_1K
    ...
    # BOOTLOGO_ADDR = FREERTOS_ADDR - FREERTOS_SIZE - BOOTLOGO_SIZE
