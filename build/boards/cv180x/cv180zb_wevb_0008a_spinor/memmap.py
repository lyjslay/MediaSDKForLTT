...
class MemoryMap:
    ...
    SHARE_MEM_ADDR = ALIOS_RESV_ADDR + ALIOS_RESV_SIZE
    ...
    CONFIG_SYS_TEXT_BASE = FREERTOS_ADDR - 0x100000

    # SYS_TEXT_SIZE 1M
    assert CONFIG_SYS_TEXT_BASE - 0x10000 >= BOOTLOGO_ADDR + BOOTLOGO_SIZE
