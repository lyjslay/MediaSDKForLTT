...
int test_osd_basic(const char *inputfile, const char *outputfile_base)
{
    ...
    CHECK_RET(CVI_MAPI_VPROC_Init(&vproc, 2, &vproc_attr));
    ...
    osdAttr.stContent.stTimeContent.enTimeFmt = CVI_MAPI_OSD_TIMEFMT_YMD24H;
    osdAttr.stContent.stTimeContent.u32BgColor = 0x7fff;//rgn bgcolor
    ret = CVI_MAPI_OSD_SetAttr(osdIdx, &osdAttr);
    if (ret == 0) {
    ...
    osdAttr.stContent.enType = CVI_MAPI_OSD_TYPE_BITMAP;
    ...
    osdAttr.astDispAttr[0].u32Batch = 1;
    osdAttr.stContent.enType = CVI_MAPI_OSD_TYPE_CIRCLE;
    osdAttr.stContent.u32Color = 0xffff; 
    ...
    osdAttr.astDispAttr[0].stStartPos.s32Y = 96;
    osdAttr.astDispAttr[0].u32Batch = 1;
    osdAttr.stContent.enType = CVI_MAPI_OSD_TYPE_STRING;
    osdAttr.stContent.u32Color = 0xffff; 
    osdAttr.stContent.stStrContent.stFontSize.u32Width = 24;
    osdAttr.stContent.stStrContent.stFontSize.u32Height = 24;
    snprintf(osdAttr.stContent.stStrContent.szStr, CVI_MAPI_OSD_MAX_STR_LEN, "������");//gb2312
    ...
    CVI_MAPI_DISP_HANDLE_T disp = videoOutCfg.dispCfg[0].dispHdl;
    ...
    CHECK_RET(CVI_MAPI_VPROC_GetChnFrame(vproc, vproc_chn_id_0,
                                         &frame_chn_0));
    CHECK_RET(CVI_MAPI_DISP_SendFrame(disp, &frame_chn_0));
