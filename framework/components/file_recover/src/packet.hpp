...
constexpr int32_t NAL_HEADER_START_POS = 4;
constexpr int32_t H264_NAL_HEADER_LENGTH = 1;
constexpr int32_t H265_NAL_HEADER_LENGTH = 2;
constexpr int32_t JPEG_SOI_LENGTH = 2;
constexpr int32_t JPEG_EOI_LENGTH = 2;
...
inline Codec getVideoCodecByData(const uint8_t *data)
{
    ...
    for (int32_t check_codec = static_cast<int32_t>(Codec::H265);
            check_codec > static_cast<int32_t>(Codec::Unknown); --check_codec) {
