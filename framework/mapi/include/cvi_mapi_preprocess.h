#ifndef __CVI_MAPI_PREPROCESS_H__
#define __CVI_MAPI_PREPROCESS_H__
...
static inline void CVI_MAPI_PREPROCESS_ENABLE(VPSS_CHN_ATTR_S *attr_chn,
...
#endif // __CVI_MAPI_PREPROCESS_H__
