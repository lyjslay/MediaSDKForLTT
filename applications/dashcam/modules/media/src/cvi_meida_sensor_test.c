...
static CVI_U32 calcExpLine(CVI_U8 sID, uint32_t expTime)
{
	CVI_U32 expLine = 0;
...
static void AE_SetManualExposureTest(CVI_U8 sID, CVI_U8 mode, uint32_t expTime, uint32_t ISONum)
{
...
static void AE_GainLinearTest(CVI_U8 sID, uint32_t expTime, CVI_U32 StartISONum, CVI_U32 EndISONum)
{
