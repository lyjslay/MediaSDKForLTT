...
typedef ret_t (*CVI_UIFunc_CallBack)(void* ctx, event_t* e);

typedef enum cviUIWINDOWMNG_ID {
    UI_HOME_PAGE,
    UI_DIR_PAGE,
    UI_PLAYBACK_PAGE,
    UI_OPTION_PAGE,
...
typedef struct tagUI_WINDOW_CALLBACK_S {
    CVI_UIFunc_CallBack ui_open;
    CVI_UIFunc_CallBack ui_close;
...
int32_t ui_winmng_receivemsgresult(CVI_EVENT_S* pstEvent);
