...
static UI_MENU_SEL_S ui_resoultion[MENU_ITEM_NUM_THREE] = {
    { "STRID_1440P" , CVI_MEDIA_VIDEO_SIZE_2560X1440P30 },
    { "STRID_1080P" , CVI_MEDIA_VIDEO_SIZE_1920X1080P30 },
    { "STRID_720P"  , CVI_MEDIA_VIDEO_SIZE_1280X720P30  },
};
static UI_MENU_SEL_S ui_audio[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MEDIA_VIDEO_AUDIO_ON  },
    { "STRID_OFF" , CVI_MEDIA_VIDEO_AUDIO_OFF },
};
static UI_MENU_SEL_S ui_datestamp[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MEDIA_VIDEO_OSD_ON     },
    { "STRID_OFF" , CVI_MEDIA_VIDEO_OSD_OFF    },
};
static UI_MENU_SEL_S ui_optionloop[MENU_ITEM_NUM_THREE] = {
    { "STRID_1MIN" , CVI_MEDIA_VIDEO_LOOP_1MIN },
    { "STRID_3MIN" , CVI_MEDIA_VIDEO_LOOP_3MIN },
    { "STRID_5MIN" , CVI_MEDIA_VIDEO_LOOP_5MIN },
};
static UI_MENU_SEL_S ui_gensor[MENU_ITEM_NUM_FOUR] = {
    { "STRID_OFF"     , CVI_MENU_GENSOR_OFF },
    { "STRID_LOW"     , CVI_MENU_GENSOR_LOW },
    { "STRID_MIDDLE"  , CVI_MENU_GENSOR_MID },
    { "STRID_HIGH"    , CVI_MENU_GENSOR_HIGH },
};
static UI_MENU_SEL_S ui_fatiguedriving[MENU_ITEM_NUM_FIVE] = {
    { "STRID_OFF"  , CVI_MENU_FATIGUEDRIVE_OFF},
    { "STRID_1H"   , CVI_MENU_FATIGUEDRIVE_1HOUR},
    { "STRID_2H"   , CVI_MENU_FATIGUEDRIVE_2HOUR},
    { "STRID_3H"   , CVI_MENU_FATIGUEDRIVE_3HOUR},
    { "STRID_4H"   , CVI_MENU_FATIGUEDRIVE_4HOUR},
};
static UI_MENU_SEL_S ui_gpscontrol[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MENU_GPSSTAMP_ON},
    { "STRID_OFF" , CVI_MENU_GPSSTAMP_OFF},
};
static UI_MENU_SEL_S ui_speedunit[MENU_ITEM_NUM_TWO] = {
    { "KMH"  , CVI_MENU_SPEEDUNIT_KMH},
    { "MPH"  , CVI_MENU_SPEEDUNIT_MPH},
};
static UI_MENU_SEL_S ui_rearcammirror[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MENU_REARCAM_MIRROR_ON},
    { "STRID_OFF" , CVI_MENU_REARCAM_MIRROR_OFF},
};
static UI_MENU_SEL_S ui_wifi[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MENU_WIFI_ON},
    { "STRID_OFF" , CVI_MENU_WIFI_OFF},
};
static UI_MENU_SEL_S ui_language[MENU_ITEM_NUM_TWO] = {
    { "STRID_ZH"  , CVI_MENU_LANGUAGE_CHN},
    { "STRID_EN"  , CVI_MENU_LANGUAGE_ENG},
};
static UI_MENU_SEL_S ui_timezone[MENU_ITEM_NUM_FIVE] = {
    { "CHN"  , CVI_MENU_TIME_ZONE_CHN},
    { "ENG"  , CVI_MENU_TIME_ZONE_ENG},
    { "UNI"  , CVI_MENU_TIME_ZONE_UNI},
    { "JAP"  , CVI_MENU_TIME_ZONE_JAP},
    { "EGP"  , CVI_MENU_TIME_ZONE_EGP},
};
static UI_MENU_SEL_S ui_clicktone[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MEDIA_AUDIO_KEYTONE_ON},
    { "STRID_OFF" , CVI_MEDIA_AUDIO_KEYTONE_OFF},
};
static UI_MENU_SEL_S ui_parking[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MENU_PARKING_ON},
    { "STRID_OFF" , CVI_MENU_PARKING_OFF},
};
static UI_MENU_SEL_S ui_speedmark[MENU_ITEM_NUM_TWO] = {
    { "STRID_ON"  , CVI_MENU_SPEEDSTAMP_ON},
    { "STRID_OFF" , CVI_MENU_SPEEDSTAMP_OFF},
};
static UI_MENU_SEL_S ui_timefomat[MENU_ITEM_NUM_TWO] = {
    { "STRID_12H"  , CVI_MENU_TIME_FORMAT_12},
    { "STRID_24H"  , CVI_MENU_TIME_FORMAT_24},
};
static UI_MENU_SEL_S ui_frequency[MENU_ITEM_NUM_THREE] = {
    { "STRID_OFF"   , CVI_MENU_FREQUENCY_OFF},
    { "STRID_50HZ"  , CVI_MENU_FREQUENCY_50},
    { "STRID_60HZ"  , CVI_MENU_FREQUENCY_60},
};
static UI_MENU_SEL_S ui_screensaver[MENU_ITEM_NUM_FOUR] = {
    { "STRID_OFF"  , CVI_MENU_SCREENDORMANT_OFF},
    { "STRID_1MIN" , CVI_MENU_SCREENDORMANT_1MIN},
    { "STRID_3MIN" , CVI_MENU_SCREENDORMANT_3MIN},
    { "STRID_5MIN" , CVI_MENU_SCREENDORMANT_5MIN},
};
...
static UI_OPTION_SEL_S option[MENU_ITEM_ID_MAX] = {
    // page 1
    {MENU_ITEM_NUM_THREE ,  ui_resoultion   ,  CVI_PARAM_MENU_VIDEO_SIZE    },
    {MENU_ITEM_NUM_TWO   ,  ui_audio        ,  CVI_PARAM_MENU_AUDIO_STATUS  },
    {MENU_ITEM_NUM_TWO   ,  ui_datestamp    ,  CVI_PARAM_MENU_OSD_STATUS    },    //  date button
    {MENU_ITEM_NUM_THREE ,  ui_optionloop   ,  CVI_PARAM_MENU_VIDEO_LOOP    },    //  looprecording
    {MENU_ITEM_NUM_FOUR  ,  ui_gensor       ,  CVI_PARAM_MENU_GSENSOR       },
    {MENU_ITEM_NUM_FIVE  ,  ui_fatiguedriving, CVI_PARAM_MENU_FATIGUE_DRIVE },    //  疲劳驾驶
    {MENU_ITEM_NUM_TWO   ,  ui_speedmark    ,  CVI_PARAM_MENU_SPEED_STAMP   },    //  speed buttom
    {MENU_ITEM_NUM_TWO   ,  ui_gpscontrol   ,  CVI_PARAM_MENU_GPS_STAMP     },
    //page 2
    {MENU_ITEM_NUM_TWO   ,  ui_speedunit    ,  CVI_PARAM_MENU_SPEED_UNIT    },    // 速度单位
    {MENU_ITEM_GPS_INFO  ,  ui_gpsinfo      ,  0                            },    // gpsinfo
    {MENU_ITEM_NUM_TWO   ,  ui_rearcammirror,  CVI_PARAM_MENU_REARCAM_MIRROR},    // rearcammirror 后路镜像
    {0                   ,  NULL            ,  0                            },    // app
    {MENU_ITEM_NUM_TWO   ,  ui_wifi         ,  CVI_PARAM_MENU_WIFI_STATUS   },
    {MENU_ITEM_NUM_TWO   ,  ui_language     ,  CVI_PARAM_MENU_LANGUAGE      },
    {MENU_ITEM_NUM_TWO   ,  ui_timefomat    ,  CVI_PARAM_MENU_TIME_FORMAT   },    // timefomat
    {MENU_ITEM_DATE_TIME ,  NULL            ,  0                            },    // datetime
    //page 3
    {MENU_ITEM_NUM_FIVE  ,  ui_timezone     ,  CVI_PARAM_MENU_TIME_ZONE     },    // timezone
    {MENU_ITEM_NUM_THREE ,  ui_frequency    ,  CVI_PARAM_MENU_FREQUENCY     },    // frequency
    {MENU_ITEM_NUM_TWO   ,  ui_clicktone    ,  CVI_PARAM_MENU_KEYTONE       },    // 按键声
    {MENU_ITEM_NUM_FOUR  ,  ui_screensaver  ,  CVI_PARAM_MENU_SCREENDORMANT },    // screensaver
    {MENU_ITEM_NUM_TWO   ,  ui_parking      ,  CVI_PARAM_MENU_PARKING       },
...
void option_setuiLanguage(int32_t  param)
{
    switch (param)
    {
        case CVI_MENU_LANGUAGE_CHN:
            locale_info_change(locale_info(), "zh", "CN");
            break;
        case CVI_MENU_LANGUAGE_ENG:
...
static int32_t  option_OnReceiveMsgResult(CVI_EVENT_S* pstEvent)
{
    // int32_t  s32Ret = 0;
    (void)pstEvent;
...
static int32_t  option_OnReceiveMsgDefaultResult(CVI_EVENT_S* pstEvent)
{
    // int32_t  s32Ret = 0;
    (void)pstEvent;
...
static void save_option_to_param(void)
{
    ...
    CVI_UICOMM_SendAsyncMsg(&Msg, option_OnReceiveMsgResult);

    // CVI_PARAM_SetMenuParam(0, option[curIndx].option_menu, option[curIndx].option_name[array[curIndx]].param);
...
{
    CVI_PARAM_DEVMNG_S dev_param = {0};
    CVI_PARAM_GetDevParam(&dev_param);
    CVI_PARAM_GetMenuParam(&menu_param);
    ...
    switch(s_page_info.cur_button_id)
    {
        ...
        {
            CVI_MEDIA_VIDEO_SIZE_E size;
            CVI_PARAM_GetVideoSizeEnum(menu_param.VideoSize.Current, &size);
        ...
        case DEFAULT_BUTTON:
            {
                ...
                CVI_UICOMM_SendAsyncMsg(&Msg, option_OnReceiveMsgDefaultResult);
                break;
            }
    }
